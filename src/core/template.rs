...
add_custom_command(TARGET ${{EXECUTABLE}} POST_BUILD
    ...
    format!(
        r#"# Auto-generated by mcuforge — {name}
...
pub fn generate_clangd_config(
    ...
    format!(
        r#"# Auto-generated by mcuforge — clangd LSP configuration
...
pub fn generate_toolchain_cmake(vendor: &str, version: &str) -> String {
    ...
    format!(
        r#"# Auto-generated by mcuforge — DO NOT EDIT
# Toolchain: {VENDOR} ARM GCC {version}
# Run 'mcuforge setup' to regenerate
